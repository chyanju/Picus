...
; (assert (= y54 #f10492955399876896616031380316375036116785522859509710290107005323731247847451m21888242871839275222246405745257275088548364400416034343698204186575808495617))
...
; (assert (= y57 #f19969041817951663183392011728224309505812177947394151196320662350244020711267m21888242871839275222246405745257275088548364400416034343698204186575808495617))
...
;   (not (= y54 #f10492955399876896616031380316375036116785522859509710290107005323731247847451m21888242871839275222246405745257275088548364400416034343698204186575808495617))
...
;   (not (= y57 #f19969041817951663183392011728224309505812177947394151196320662350244020711267m21888242871839275222246405745257275088548364400416034343698204186575808495617))
...
; no more solution for x54
; switch to x53
; (assert (not (= x53 y53)))

; no more solution for x53
; counter-example is rejected by adr3
; it's safe with adr3
; wait for adr3
