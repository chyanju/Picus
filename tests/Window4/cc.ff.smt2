...
(assert (= y24 #f0m21888242871839275222246405745257275088548364400416034343698204186575808495617))
; hints from adr5
(assert (= x25 #f2661034181063526690380968414130598626815208015128985754079958221158257086763m21888242871839275222246405745257275088548364400416034343698204186575808495617))
...
; hints from adr6
(assert (= x32 #f0m21888242871839275222246405745257275088548364400416034343698204186575808495617))
...
(assert (= x36 #f2661034181063526690380968414130598626815208015128985754079958221158257086763m21888242871839275222246405745257275088548364400416034343698204186575808495617))
...
; hints from adr7
(assert (= x39 #f2661034181063526690380968414130598626815208015128985754079958221158257086763m21888242871839275222246405745257275088548364400416034343698204186575808495617))
...
(assert (= x43 #f0m21888242871839275222246405745257275088548364400416034343698204186575808495617))
...
; hints from adr8
(assert (= x46 #f0m21888242871839275222246405745257275088548364400416034343698204186575808495617))
...
(assert (= x50 #f2661034181063526690380968414130598626815208015128985754079958221158257086763m21888242871839275222246405745257275088548364400416034343698204186575808495617))
