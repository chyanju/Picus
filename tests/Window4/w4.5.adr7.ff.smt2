...
; hints from adr3
(assert (= x9 #f19227208690775748531865437331126676461733156385287048589618245965417551240156m21888242871839275222246405745257275088548364400416034343698204186575808495617))
(assert (= x10 #f0m21888242871839275222246405745257275088548364400416034343698204186575808495617))
(assert (= x11 #f5322068362127053380761936828261197253630416030257971508159916442316514342224m21888242871839275222246405745257275088548364400416034343698204186575808495617))
(assert (= x12 #f0m21888242871839275222246405745257275088548364400416034343698204186575808495617))
(assert (= x13 #f19227208690775748531865437331126676461733156385287048589618245965417551240156m21888242871839275222246405745257275088548364400416034343698204186575808495617))
(assert (= x14 #f0m21888242871839275222246405745257275088548364400416034343698204186575808495617))
(assert (= x15 #f19227208690775748531865437331126676461733156385287048589618245965417551240156m21888242871839275222246405745257275088548364400416034343698204186575808495617))
...
(assert (= x53 #f19227208690775748531865437331126676461733156385287048589618245965417551240156m21888242871839275222246405745257275088548364400416034343698204186575808495617))
(assert (= x54 #f0m21888242871839275222246405745257275088548364400416034343698204186575808495617))
(assert (= x55 #f19227208690775748531865437331126676461733156385287048589618245965417551240156m21888242871839275222246405745257275088548364400416034343698204186575808495617))
(assert (= x56 #f0m21888242871839275222246405745257275088548364400416034343698204186575808495617))
(assert (= x57 #f17227713526953394140741591647523112279518733089659685263306152777950041868941m21888242871839275222246405745257275088548364400416034343698204186575808495617))
(assert (= x58 #f18039640916646237372880335511686420348069741665070947478680356439334569097561m21888242871839275222246405745257275088548364400416034343698204186575808495617))
(assert (= y53 #f19227208690775748531865437331126676461733156385287048589618245965417551240156m21888242871839275222246405745257275088548364400416034343698204186575808495617))
(assert (= y54 #f0m21888242871839275222246405745257275088548364400416034343698204186575808495617))
(assert (= y55 #f19227208690775748531865437331126676461733156385287048589618245965417551240156m21888242871839275222246405745257275088548364400416034343698204186575808495617))
(assert (= y56 #f0m21888242871839275222246405745257275088548364400416034343698204186575808495617))
(assert (= y57 #f17227713526953394140741591647523112279518733089659685263306152777950041868941m21888242871839275222246405745257275088548364400416034343698204186575808495617))
(assert (= y58 #f18039640916646237372880335511686420348069741665070947478680356439334569097561m21888242871839275222246405745257275088548364400416034343698204186575808495617))
; hints from adr4
(assert (= x18 #f19227208690775748531865437331126676461733156385287048589618245965417551240156m21888242871839275222246405745257275088548364400416034343698204186575808495617))
(assert (= x19 #f0m21888242871839275222246405745257275088548364400416034343698204186575808495617))
(assert (= x20 #f19227208690775748531865437331126676461733156385287048589618245965417551240156m21888242871839275222246405745257275088548364400416034343698204186575808495617))
(assert (= x21 #f0m21888242871839275222246405745257275088548364400416034343698204186575808495617))
(assert (= x22 #f5322068362127053380761936828261197253630416030257971508159916442316514342224m21888242871839275222246405745257275088548364400416034343698204186575808495617))
...
(assert (= y18 #f2661034181063526690380968414130598626815208015128985754079958221158257086763m21888242871839275222246405745257275088548364400416034343698204186575808495617))
(assert (= y19 #f0m21888242871839275222246405745257275088548364400416034343698204186575808495617))
(assert (= y20 #f19227208690775748531865437331126676461733156385287048589618245965417551240156m21888242871839275222246405745257275088548364400416034343698204186575808495617))
(assert (= y21 #f0m21888242871839275222246405745257275088548364400416034343698204186575808495617))
(assert (= y22 #f0m21888242871839275222246405745257275088548364400416034343698204186575808495617))
...
; hints from adr5
(assert (= x25 #f5322068362127053380761936828261197253630416030257971508159916442316514342224m21888242871839275222246405745257275088548364400416034343698204186575808495617))
(assert (= x26 #f0m21888242871839275222246405745257275088548364400416034343698204186575808495617))
(assert (= x27 #f19227208690775748531865437331126676461733156385287048589618245965417551240156m21888242871839275222246405745257275088548364400416034343698204186575808495617))
(assert (= x28 #f0m21888242871839275222246405745257275088548364400416034343698204186575808495617))
(assert (= x29 #f19227208690775748531865437331126676461733156385287048589618245965417551240156m21888242871839275222246405745257275088548364400416034343698204186575808495617))
(assert (= x30 #f0m21888242871839275222246405745257275088548364400416034343698204186575808495617))
(assert (= x31 #f0m21888242871839275222246405745257275088548364400416034343698204186575808495617))
...
(assert (= y27 #f19227208690775748531865437331126676461733156385287048589618245965417551240156m21888242871839275222246405745257275088548364400416034343698204186575808495617))
(assert (= y28 #f0m21888242871839275222246405745257275088548364400416034343698204186575808495617))
(assert (= y29 #f2661034181063526690380968414130598626815208015128985754079958221158257086763m21888242871839275222246405745257275088548364400416034343698204186575808495617))
(assert (= y30 #f0m21888242871839275222246405745257275088548364400416034343698204186575808495617))
(assert (= y31 #f0m21888242871839275222246405745257275088548364400416034343698204186575808495617))
; hints from adr6
(assert (= x32 #f19227208690775748531865437331126676461733156385287048589618245965417551240156m21888242871839275222246405745257275088548364400416034343698204186575808495617))
(assert (= x33 #f0m21888242871839275222246405745257275088548364400416034343698204186575808495617))
(assert (= x34 #f19227208690775748531865437331126676461733156385287048589618245965417551240156m21888242871839275222246405745257275088548364400416034343698204186575808495617))
(assert (= x35 #f0m21888242871839275222246405745257275088548364400416034343698204186575808495617))
(assert (= x36 #f5322068362127053380761936828261197253630416030257971508159916442316514342224m21888242871839275222246405745257275088548364400416034343698204186575808495617))
(assert (= x37 #f0m21888242871839275222246405745257275088548364400416034343698204186575808495617))
(assert (= x38 #f0m21888242871839275222246405745257275088548364400416034343698204186575808495617))
(assert (= y32 #f2661034181063526690380968414130598626815208015128985754079958221158257086763m21888242871839275222246405745257275088548364400416034343698204186575808495617))
(assert (= y33 #f0m21888242871839275222246405745257275088548364400416034343698204186575808495617))
(assert (= y34 #f19227208690775748531865437331126676461733156385287048589618245965417551240156m21888242871839275222246405745257275088548364400416034343698204186575808495617))
(assert (= y35 #f0m21888242871839275222246405745257275088548364400416034343698204186575808495617))
(assert (= y36 #f0m21888242871839275222246405745257275088548364400416034343698204186575808495617))
(assert (= y37 #f0m21888242871839275222246405745257275088548364400416034343698204186575808495617))
(assert (= y38 #f0m21888242871839275222246405745257275088548364400416034343698204186575808495617))

(assert (not (= x39 y39)))

; solution #1
; (assert (= x39 #f5322068362127053380761936828261197253630416030257971508159916442316514342224m21888242871839275222246405745257275088548364400416034343698204186575808495617))
; (assert (= x40 #f0m21888242871839275222246405745257275088548364400416034343698204186575808495617))
; (assert (= x41 #f19227208690775748531865437331126676461733156385287048589618245965417551240156m21888242871839275222246405745257275088548364400416034343698204186575808495617))
; (assert (= x42 #f0m21888242871839275222246405745257275088548364400416034343698204186575808495617))
; (assert (= x43 #f19227208690775748531865437331126676461733156385287048589618245965417551240156m21888242871839275222246405745257275088548364400416034343698204186575808495617))
; (assert (= x44 #f0m21888242871839275222246405745257275088548364400416034343698204186575808495617))
; (assert (= x45 #f0m21888242871839275222246405745257275088548364400416034343698204186575808495617))
; (assert (= y39 #f0m21888242871839275222246405745257275088548364400416034343698204186575808495617))
; (assert (= y40 #f0m21888242871839275222246405745257275088548364400416034343698204186575808495617))
; (assert (= y41 #f19227208690775748531865437331126676461733156385287048589618245965417551240156m21888242871839275222246405745257275088548364400416034343698204186575808495617))
; (assert (= y42 #f0m21888242871839275222246405745257275088548364400416034343698204186575808495617))
; (assert (= y43 #f2661034181063526690380968414130598626815208015128985754079958221158257086763m21888242871839275222246405745257275088548364400416034343698204186575808495617))
; (assert (= y44 #f0m21888242871839275222246405745257275088548364400416034343698204186575808495617))
; (assert (= y45 #f0m21888242871839275222246405745257275088548364400416034343698204186575808495617))


; ask adr8 for satisfiability
