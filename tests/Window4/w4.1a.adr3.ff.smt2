...
; unsat, tell dbl2 to reject hints
; dbl2 returns no more hints

; generate your own counter-example
; since dbl2 is safe, the following should be added
(assert (= x13 y13))
(assert (= x14 y14))
(assert (= x15 y15))
(assert (= x16 y16))

; and expand the scope to include dbl2, see next smt2 file
