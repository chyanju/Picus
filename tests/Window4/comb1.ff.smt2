...
(assert (= y25 #f19227208690775748531865437331126676461733156385287048589618245965417551240156m21888242871839275222246405745257275088548364400416034343698204186575808495617))
...
(assert (= y31 #f17227713526953394140741591647523112279518733089659685263306152777950041868941m21888242871839275222246405745257275088548364400416034343698204186575808495617))
(assert (= y32 #f5322068362127053380761936828261197253630416030257971508159916442316514342224m21888242871839275222246405745257275088548364400416034343698204186575808495617))
...
(assert (= y36 #f19227208690775748531865437331126676461733156385287048589618245965417551240156m21888242871839275222246405745257275088548364400416034343698204186575808495617))
...
; (assert (= x46 #f19227208690775748531865437331126676461733156385287048589618245965417551240156m21888242871839275222246405745257275088548364400416034343698204186575808495617))
; (assert (= x47 #f0m21888242871839275222246405745257275088548364400416034343698204186575808495617))
; (assert (= x48 #f19227208690775748531865437331126676461733156385287048589618245965417551240156m21888242871839275222246405745257275088548364400416034343698204186575808495617))
; (assert (= x49 #f0m21888242871839275222246405745257275088548364400416034343698204186575808495617))
; (assert (= x50 #f5322068362127053380761936828261197253630416030257971508159916442316514342224m21888242871839275222246405745257275088548364400416034343698204186575808495617))
; (assert (= x51 #f0m21888242871839275222246405745257275088548364400416034343698204186575808495617))
; (assert (= x52 #f0m21888242871839275222246405745257275088548364400416034343698204186575808495617))
; (assert (= y39 #f19227208690775748531865437331126676461733156385287048589618245965417551240156m21888242871839275222246405745257275088548364400416034343698204186575808495617))
...
; (assert (= y43 #f5322068362127053380761936828261197253630416030257971508159916442316514342224m21888242871839275222246405745257275088548364400416034343698204186575808495617))
...
; (assert (= y46 #f5322068362127053380761936828261197253630416030257971508159916442316514342224m21888242871839275222246405745257275088548364400416034343698204186575808495617))
; (assert (= y47 #f0m21888242871839275222246405745257275088548364400416034343698204186575808495617))
; (assert (= y48 #f19227208690775748531865437331126676461733156385287048589618245965417551240156m21888242871839275222246405745257275088548364400416034343698204186575808495617))
; (assert (= y49 #f0m21888242871839275222246405745257275088548364400416034343698204186575808495617))
; (assert (= y50 #f19227208690775748531865437331126676461733156385287048589618245965417551240156m21888242871839275222246405745257275088548364400416034343698204186575808495617))
; (assert (= y51 #f0m21888242871839275222246405745257275088548364400416034343698204186575808495617))
; (assert (= y52 #f0m21888242871839275222246405745257275088548364400416034343698204186575808495617))
