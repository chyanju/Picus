...
; hints from adr3
(assert (= x9 zero)) ; shared
(assert (= x10 zero)) ; shared
...
(assert (= y17 one))
; hints from adr4
(assert (= x18 #f17917025024279319843466144915302109229998225847490577259024937405824878952295m21888242871839275222246405745257275088548364400416034343698204186575808495617))
(assert (= x19 zero))
(assert (= x20 #f3971217847559955378780260829955165858550138552925457084673266780750929543322m21888242871839275222246405745257275088548364400416034343698204186575808495617))
(assert (= x21 zero))
(assert (= x22 #f21888242871839275222246405745257275088548364400416034343698204186575808326919m21888242871839275222246405745257275088548364400416034343698204186575808495617))
(assert (= x23 zero))
(assert (= x24 zero))
(assert (= y18 zero))
(assert (= y19 #f912348562904193202079414142803795367065740667729344444849426186180996542882m21888242871839275222246405745257275088548364400416034343698204186575808495617))
(assert (= y20 #f3971217847559955378780260829955165858550138552925457084673266780750929543322m21888242871839275222246405745257275088548364400416034343698204186575808495617))
(assert (= y21 zero))
(assert (= y22 #f21888242871839275222246405745257275088548364400416034343698204186575808326920m21888242871839275222246405745257275088548364400416034343698204186575808495617))
(assert (= y23 #f168697m21888242871839275222246405745257275088548364400416034343698204186575808495617))
(assert (= y24 #f3971217847559955378780260829955165858550138552925457084673266780750929712020m21888242871839275222246405745257275088548364400416034343698204186575808495617))
; hints from adr5
(assert (= x25 zero))
(assert (= x26 zero))
(assert (= x27 #f3971217847559955378780260829955165858550138552925457084673266780750929374624m21888242871839275222246405745257275088548364400416034343698204186575808495617))
(assert (= x28 zero))
(assert (= x29 #f17917025024279319843466144915302109229998225847490577259024937405824878952295m21888242871839275222246405745257275088548364400416034343698204186575808495617))
(assert (= x30 zero))
(assert (= x31 zero))
(assert (= y25 #f17139069718728371144715042009300790902133639714118587609591067364236034519381m21888242871839275222246405745257275088548364400416034343698204186575808495617))
(assert (= y26 #f13743089809524031167220483414140956816901686999609880951563783075010839246770m21888242871839275222246405745257275088548364400416034343698204186575808495617))
(assert (= y27 #f3971217847559955378780260829955165858550138552925457084673266780750929374624m21888242871839275222246405745257275088548364400416034343698204186575808495617))
(assert (= y28 zero))
(assert (= y29 zero))
(assert (= y30 #f912348562904193202079414142803795367065740667729344444849426186180996542882m21888242871839275222246405745257275088548364400416034343698204186575808495617))
(assert (= y31 #f9380961566808454165736609183172703462656603539465435566613203392699760150249m21888242871839275222246405745257275088548364400416034343698204186575808495617))
; hints from adr6
(assert (= x32 #f21888242871839275222246405745257275088548364400416034343698204186575808326919m21888242871839275222246405745257275088548364400416034343698204186575808495617))
(assert (= x33 zero))
(assert (= x34 zero))
(assert (= x35 zero))
(assert (= x36 zero))
(assert (= x37 zero))
(assert (= x38 zero))
(assert (= y32 #f18501692509002897685195099061392956291667721347139904938637103997508915094186m21888242871839275222246405745257275088548364400416034343698204186575808495617))
(assert (= y33 #f10050407469249122415436264302229356746049726110878900051958417884814556626168m21888242871839275222246405745257275088548364400416034343698204186575808495617))
(assert (= y34 zero))
(assert (= y35 zero))
(assert (= y36 #f17139069718728371144715042009300790902133639714118587609591067364236034519381m21888242871839275222246405745257275088548364400416034343698204186575808495617))
(assert (= y37 #f13743089809524031167220483414140956816901686999609880951563783075010839246770m21888242871839275222246405745257275088548364400416034343698204186575808495617))
(assert (= y38 #f5670655519482015123525485837889634671954158077308952004190127154177660728410m21888242871839275222246405745257275088548364400416034343698204186575808495617))
; hints from adr7
(assert (= x39 zero))
(assert (= x40 zero))
(assert (= x41 zero))
(assert (= x42 zero))
(assert (= x43 #f21888242871839275222246405745257275088548364400416034343698204186575808326919m21888242871839275222246405745257275088548364400416034343698204186575808495617))
(assert (= x44 zero))
(assert (= x45 zero))
(assert (= y39 #f17139069718728371144715042009300790902133639714118587609591067364236034519381m21888242871839275222246405745257275088548364400416034343698204186575808495617))
(assert (= y40 #f13743089809524031167220483414140956816901686999609880951563783075010839246770m21888242871839275222246405745257275088548364400416034343698204186575808495617))
(assert (= y41 zero))
(assert (= y42 zero))
(assert (= y43 #f18501692509002897685195099061392956291667721347139904938637103997508915094186m21888242871839275222246405745257275088548364400416034343698204186575808495617))
(assert (= y44 #f10050407469249122415436264302229356746049726110878900051958417884814556626168m21888242871839275222246405745257275088548364400416034343698204186575808495617))
(assert (= y45 #f16217587352357260098720919907367640416594206323107082339508077032398147767207m21888242871839275222246405745257275088548364400416034343698204186575808495617))
...
; solution
; (assert (= x46 #f21888242871839275222246405745257275088548364400416034343698204186575808326919m21888242871839275222246405745257275088548364400416034343698204186575808495617))
; (assert (= x47 zero))
; (assert (= x48 zero))
; (assert (= x49 zero))
; (assert (= x50 zero))
; (assert (= x51 zero))
; (assert (= x52 zero))
; (assert (= y46 #f18501692509002897685195099061392956291667721347139904938637103997508915094186m21888242871839275222246405745257275088548364400416034343698204186575808495617))
; (assert (= y47 #f10050407469249122415436264302229356746049726110878900051958417884814556626168m21888242871839275222246405745257275088548364400416034343698204186575808495617))
; (assert (= y48 zero))
; (assert (= y49 zero))
; (assert (= y50 #f17139069718728371144715042009300790902133639714118587609591067364236034519381m21888242871839275222246405745257275088548364400416034343698204186575808495617))
; (assert (= y51 #f13743089809524031167220483414140956816901686999609880951563783075010839246770m21888242871839275222246405745257275088548364400416034343698204186575808495617))
; (assert (= y52 #f5670655519482015123525485837889634671954158077308952004190127154177660728410m21888242871839275222246405745257275088548364400416034343698204186575808495617))
