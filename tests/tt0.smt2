...
; ======== main constraints ========
(assert (or (= 0 (+ 0 (+ (* ps1 x0) (* 1 x1)))) (= 0 (+ 0 (* 1 x1)))))
(assert (or (= 0 (+ 0 (+ (* ps1 x0) (* 1 x2)))) (= 0 (+ 0 (* 1 x2)))))
(assert (or (= 0 (+ 0 (+ (* ps1 x0) (* 1 x7)))) (= 0 (+ 0 (* 1 x7)))))
...
(assert (= ps5 21888242871839275222246405745257275088548364400416034343698204186575808495612))
; ======== main constraints ========
(assert (or (= 0 (+ 0 (+ (* ps1 x0) (* 1 y1)))) (= 0 (+ 0 (* 1 y1)))))
(assert (or (= 0 (+ 0 (+ (* ps1 x0) (* 1 y2)))) (= 0 (+ 0 (* 1 y2)))))
(assert (or (= 0 (+ 0 (+ (* ps1 x0) (* 1 y7)))) (= 0 (+ 0 (* 1 y7)))))
